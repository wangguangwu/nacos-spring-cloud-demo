package com.wangguangwu.nacoscustomstrategyconsumerservice.config;


import com.wangguangwu.nacoscustomstrategyconsumerservice.constant.ServiceConstants;
import com.wangguangwu.nacoscustomstrategyconsumerservice.loadBalancer.LeastConnectionsRoutingLoadBalancer;
import com.wangguangwu.nacoscustomstrategyconsumerservice.manager.ConnectionCounterManager;
 ...
 * 基于最小连接数选择服务实例，用于 {@link ServiceConstants#SERVICE_NAME} 服务。
 * <p>
 ...
 */
@Configuration
@LoadBalancerClient(name = ServiceConstants.SERVICE_NAME, configuration = ServiceCLeastConnectionsRoutingConfiguration.class)
public class ServiceCLeastConnectionsRoutingConfiguration {
    ...
    public LeastConnectionsRoutingLoadBalancer leastConnectionsRoutingLoadBalancer(ObjectProvider<ServiceInstanceListSupplier> serviceInstanceListSupplierProvider,
        ...
        return new LeastConnectionsRoutingLoadBalancer(serviceInstanceListSupplierProvider, ServiceConstants.SERVICE_NAME, connectionCounterManager);
    }
}
